...
<head>
    ...
    <link rel="stylesheet" href="../../www/css/styles.min.css?1234">

    <link rel="icon" sizes="32x32" href="../../favicon.png">

    <script src="../../www/js/fontAwesome.js" crossorigin="anonymous"></script>
    <script src="../../www/js/sadQuery.js"></script>
    <script src="../../www/js/main.min.js?123"></script>

    <title>STUDENTI | KUM</title>
</head>
<body>
